 ...
 */
public abstract class SentRequestManager extends BaseDataManager
        implements DataLoadingSubject {

    private List<Profile> mListProfile;
    private String sessionId;

    public SentRequestManager(Context context) {
        super(context);
    ...
    public void loadData()
    {
        ...
        mWebApi.getConnectionRequestSent(sessionId, getOffset(), new IResponse<List<Profile>>() {
