...
public class StorageService {
	...
	public StorageService(Context context) {
		mContext = context;		
		try {
			mClient = new MobileServiceClient("https://mobileserviceurl.azure-mobile.net/", "u0j/nmCL9BpPJA/amCKRZ5yxxqENsu/LvYxlm6fDFz2UJmqk9MVGCBPvOAld9/OjcE7tnvlfdu67b1ItoZfsLw==", mContext);
